...
const ELEMENT_DATA = [
    [AetherEnums.ElementType.FIRE,  "FIRE", Color(1.0, 0.3, 0.1)],
    [AetherEnums.ElementType.WATER, "WATER", Color(0.1, 0.8, 1.0)],
    [AetherEnums.ElementType.EARTH, "EARTH", Color(0.7, 0.5, 0.1)],
    [AetherEnums.ElementType.AIR,   "AIR", Color(0.8, 0.95, 1.0)],
]
...
func _refresh_row(element: AetherEnums.ElementType) -> void:
...
func _on_xp_updated(element: AetherEnums.ElementType, _amount: int) -> void:
