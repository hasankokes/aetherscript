...
const CHALLENGE_POOL = [
    {
        ...
        "bonus_xp_element": AetherEnums.ElementType.FIRE,
        "bonus_xp": 50,
    },
    {
        "id": "only_water",
        ...
        "reward": {"aether_shard": 3, "crystal": 10},
        "bonus_xp_element": AetherEnums.ElementType.WATER,
        "bonus_xp": 50,
    },
    {
        "id": "max_6_slots",
        ...
        "bonus_xp_element": AetherEnums.ElementType.NEUTRAL,
        "bonus_xp": 0,
    },
    {
        "id": "no_modifier",
    ...
    },
    {
        ...
        "bonus_xp_element": AetherEnums.ElementType.AIR,
        "bonus_xp": 30,
    },
    {
        "id": "no_heal",
    ...
    },
    {
        ...
        "bonus_xp_element": AetherEnums.ElementType.EARTH,
        "bonus_xp": 80,
    },
]
...
func is_card_allowed(card: CardData) -> bool:
    ...
    match restriction:
        "only_element_fire":
            return card.element == AetherEnums.ElementType.FIRE or \
                   card.element == AetherEnums.ElementType.NEUTRAL
        "only_element_water":
            return card.element == AetherEnums.ElementType.WATER or \
                   card.element == AetherEnums.ElementType.NEUTRAL
        "only_element_earth":
            return card.element == AetherEnums.ElementType.EARTH or \
                   card.element == AetherEnums.ElementType.NEUTRAL
        "no_card_type_modifier":
            return card.card_type != AetherEnums.CardType.MODIFIER
        "no_heal":
            return card.card_type != AetherEnums.CardType.LOGIC
        _:
            return true
